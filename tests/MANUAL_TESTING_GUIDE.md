...
- [ ] Открыть форму регистрации `/ru/tournaments/[id]/register`
...
- [ ] Открыть форму на русском `/ru/tournaments/[id]/register`
- [ ] Проверить что все тексты на русском
- [ ] Переключить на казахский `/kk/tournaments/[id]/register`
- [ ] Проверить что тексты переключились
- [ ] Переключить на английский `/en/tournaments/[id]/register`
