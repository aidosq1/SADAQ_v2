                ...
                <div className="flex flex-col md:flex-row gap-10 items-start">
                    <div className="shrink-0 mx-auto md:mx-0">
                        ...
                        <div className="mt-4 text-center md:text-left">
                            <h3 className="text-2xl font-bold">Имя Фамилия</h3>
                            <p className="text-primary font-medium">Президент Федерации</p>
                        </div>
                    </div>
                    <div className="space-y-6 flex-1">
                        <h2 className="text-2xl font-semibold">Приветственное слово</h2>
                        <blockquote className="text-lg italic text-muted-foreground border-l-4 border-primary pl-6 py-2">
                            "Дорогие друзья! Легкая атлетика по праву считается королевой спорта.
                            Это не просто соревнования на скорость или силу, это фундамент физического развития человека.
                            Наша команда работает над тем, чтобы каждый ребенок в Казахстане имел возможность приобщиться к спорту,
                            а наши профессионалы получали лучшую поддержку для достижения исторических побед.
                            Вместе мы построим спортивное будущее нашей страны!"
                        </blockquote>
                    </div>
                </div>
            </section>
